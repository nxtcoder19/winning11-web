            ...
            <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                ...
                <nav className="flex items-center justify-between h-16 lg:h-20">
                    ...
                    <div className="hidden lg:flex lg:items-center lg:ml-auto lg:space-x-10">
                        <a href="about-us" title="" className="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About Us </a>

                        <a href="blogs" title="" className="text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Blogs </a>
                ...
                <nav className="pt-4 pb-6 bg-white border border-gray-200 rounded-md shadow-md lg:hidden">
                    <div className="flow-root">
                        <div className="flex flex-col px-6 -my-2 space-y-1">
                            <a href="about-us" title="" className="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About Us </a>

                            <a href="blogs" title="" className="inline-flex py-2 text-base font-medium text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Blogs </a>
