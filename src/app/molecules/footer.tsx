                ...
                <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
                    ...
                    <div>
                        ...
                        <ul className="mt-6 space-y-4">
                            <li>
                                <a href="about-us" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> About Us </a>
                            </li>

                            <li>
                                <a href="blogs" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Blogs </a>
                            </li>

                            <li>
                                <a href="contact-us" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Contact Us </a>
                            </li>

                            <li>
                                <a href="pricing" title="" className="flex text-base text-black transition-all duration-200 hover:text-blue-600 focus:text-blue-600"> Pricing </a>
                            </li>
                        </ul>
                    </div>
